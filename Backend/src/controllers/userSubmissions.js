...
console.log("Lnagugae is",language)
    ...
    const submittedResult = await Submission.create({
          ...
          language,
          status:'pending',
          testCasesTotal:problem.hiddentestacases.length
     })
    ...
    const submissions = problem.hiddentestacases.map((testcase)=>({
        source_code:code,
    ...
    res.status(201).json({
      ...
      res.status(500).send("Internal Server Error  hello "+ err);
    }
}
