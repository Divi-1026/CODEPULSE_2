...
export default function Home() {
  ...
  .
                ...
                <div>
  <h1
    className={`text-5xl md:text-5xl font-bold text-transparent bg-clip-text 
      ${theme=="dark"
  ...
  <p
    className={`text-2xl md:text-3xl font-semibold italic mt-2 
  ...
  {[
    ...
    >
      ...
      <div className="relative z-10">
        <div className={`w-14 h-14 rounded-lg flex items-center justify-center mb-4 ${theme === "light" ? `bg-${feature.btnColor}-100` : `bg-${feature.btnColor}-700`}`}>
