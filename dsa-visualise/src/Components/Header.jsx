...
export default function Header({ onExplore }) {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 shadow-md border-b bg-gradient-to-r from-[#d7d3f1] to-[#d7d3f1]">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 px-6 py-5">

        {/* Branding */}
        <div className="text-center md:text-left mr-0">
          <h2
            className="text-5xl font-bold text-transparent bg-clip-text"
            style={{
              backgroundImage:
                "linear-gradient(to right, #1e3a8a 0%, #60a5fa 5%, #1e3a8a 20%)",
        ...
        {/* Right section: search, explore, logout */}
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto mr-0">
          <input
            type="search"
          ...
          <button
            ...
            className="h-10 px-4 mr-0 bg-red-600 text-white text-sm font-medium rounded-md hover:bg-red-700 transition"
          >
            Logout
          </button>
        </div>
